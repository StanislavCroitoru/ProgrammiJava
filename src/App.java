//** realizzare un applicazione che tramite una form dovrà: scelta la città da un casella combinata visualizzare
//** la relativa immagine che la caratterizza. dovrà essere presente anche tre check box di tipi di prodotti tipici e
//** secondo la scelta dell'utente visualizzi la descrizione del prodotto tipico in una label
...
public class App {
    ...
    public App() {
        ...
        viewInfoButton.addActionListener(new ActionListener() {
            @Override
              public void actionPerformed(ActionEvent e) {
                if(pietanza1.isSelected()) {
                     PietanzeDesc1.setVisible(true);
                }
